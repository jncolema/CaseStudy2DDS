...
- Withing these departments, Managers and Directors have the lowest attrition rates.
    -- Is there a correlation with years in job and job role? --
    -- Is there a correlation with income and job role? --
...
-Attrition also appears to increase as Job Involvement Increases (assuming scores range from 1 as little to no involvment to 4 as High Involement) and decrease as Job Satisfaction increases.  
